...
run_shell_check "FAIL" "device_core_alias_unit" "scripts/ios/test-alias-device-real-core-project-libs.sh"
run_shell_check "FAIL" "real_core_project_sync_unit" "scripts/ios/test-sync-real-core-xcode-project.sh"
