...
| PC32 | Nome Android UI | [views/nome-android.md](views/nome-android.md) | [spec/client/nome-android-ui.md](../spec/client/nome-android-ui.md) | **Verified foundation plus authorized bounded Batch 2 production-home slice:** `common/src/androidMain/.../ui/nome/{tokens,theme,components,accessibility}/`; [Activity-owned shell](../android/src/main/java/chat/simplex/app/nome/NomeProductionShell.kt#L9-L23); shared `PlatformHomeRoute` seam with unchanged Desktop fallback; Android-only P07/P08 route/state adapter and localized resources; typed same-generation `ApiChats` load provenance in the existing shared model/controller; tests under `android/src/{test,androidTest}/.../nome/home/` and `common/src/desktopTest/.../chatlist/`. First-use/filter production reachability and all later pages remain deferred. | N/A — official v6.5.6 Haskell/native core remains unchanged |
