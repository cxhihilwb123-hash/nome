...
| PC32 | Nome Android UI | [views/nome-android.md](views/nome-android.md) | [spec/client/nome-android-ui.md](../spec/client/nome-android-ui.md) | **Verified foundation, frozen Batch 2 home and P13, plus active Batch 1A P01 source:** foundation tokens/theme/components/accessibility; Activity-owned shell; shared home seam with unchanged Desktop fallback; Android P07/P08 renderer; P13 `ACTION_VIEW`-only connection preview; and P01 root facts/seam, Android reducer/route/resources/key-read class, exact backup-copy/open separation, tests, and unchanged Desktop fallback. `FIRST_USE` and `FILTERED_NO_RESULT` remain unchanged; P09–P12 and P14–P24 remain deferred. | N/A — official v6.5.6 Haskell/native core remains unchanged |
