...
|---|---------|-------------|-----------|----------------------|----------------------|
| PC1 | Chat List | [views/chat-list.md](views/chat-list.md) | [spec/client/chat-list.md](../spec/client/chat-list.md) | Official fallback: `common/.../views/chatlist/{ChatListView,ChatListNavLinkView,ChatPreviewView}.kt`. Nome Android home: [shared platform seam](../common/src/commonMain/kotlin/chat/simplex/common/views/chatlist/PlatformHomeRoute.kt#L8-L22), [Android route](../common/src/androidMain/kotlin/chat/simplex/common/ui/nome/home/NomeHomeRoute.android.kt#L63-L123), [truth adapter](../common/src/androidMain/kotlin/chat/simplex/common/ui/nome/home/NomeHomeStateAdapter.kt#L7-L121), and [typed load provenance](../common/src/commonMain/kotlin/chat/simplex/common/model/ChatModel.kt#L81-L106). | `Controller.hs` (`APIGetChats`) |
...
| PC12 | Contact Connection | [flows/connection.md](flows/connection.md), [views/new-chat.md](views/new-chat.md) | [spec/api.md](../spec/api.md), [spec/client/navigation.md](../spec/client/navigation.md) | Upstream creation/scan/paste: `common/.../views/newchat/{NewChatView,QRCode,QRCodeScanner}.kt`. Shared plan and P13 policy: [`ConnectPlan.kt`](../common/src/commonMain/kotlin/chat/simplex/common/views/newchat/ConnectPlan.kt#L25-L607), [`PlatformConnectionPreview.kt`](../common/src/commonMain/kotlin/chat/simplex/common/views/newchat/PlatformConnectionPreview.kt#L13-L292), and the single [`ACTION_VIEW` opt-in](../common/src/commonMain/kotlin/chat/simplex/common/views/chatlist/ChatListView.kt#L760-L791). Android P13 renderer: [`NomeConnectionPreviewRoute.android.kt`](../common/src/androidMain/kotlin/chat/simplex/common/ui/nome/connection/NomeConnectionPreviewRoute.android.kt#L65-L742). | `Controller.hs` (`APIConnect`, `APIAddContact`) |
...
| PC14 | Group Management | [README.md](README.md) (Groups), [views/group-info.md](views/group-info.md) | [spec/api.md](../spec/api.md), [spec/client/nome-android-ui.md](../spec/client/nome-android-ui.md) | `common/.../views/newchat/AddGroupView.kt`, `newchat/PlatformAddGroupRoute*`, `group/AddGroupMembersView.kt`, `group/PlatformAddGroupMembersRoute*`, `group/GroupChatInfoView.kt`, `group/PlatformGroupChatInfoRoute*`, `group/GroupProfileView.kt` | `Controller.hs` (`APINewGroup`), `Store/Groups.hs` |
...
| PC20 | Incognito Mode | [README.md](README.md) (Contacts), [flows/connection.md](flows/connection.md) | [spec/api.md](../spec/api.md), [spec/client/nome-android-ui.md](../spec/client/nome-android-ui.md) | Persistent explanation: `common/.../views/usersettings/IncognitoView.kt`. P13 per-connection choice: [`ConnectionPreviewIdentity`](../common/src/commonMain/kotlin/chat/simplex/common/views/newchat/PlatformConnectionPreview.kt#L57-L60) and [`apiConnectResult`](../common/src/commonMain/kotlin/chat/simplex/common/model/SimpleXAPI.kt#L1621-L1647). | `ProfileGenerator.hs`, `Types.hs` |
...
| PC24 | Theme System | [README.md](README.md) (Customization), [views/nome-android.md](views/nome-android.md) | [spec/services/theme.md](../spec/services/theme.md), [spec/client/nome-android-ui.md](../spec/client/nome-android-ui.md) | Shared theme: `common/.../ui/theme/{ThemeManager,Theme,Color,Type,Shape}.kt`. Android Nome theme consumers include [`NomeConnectionPreviewRoute.android.kt`](../common/src/androidMain/kotlin/chat/simplex/common/ui/nome/connection/NomeConnectionPreviewRoute.android.kt#L198-L408). | `Types/UITheme.hs` |
| PC25 | Network Configuration | [README.md](README.md) (Network), [views/settings.md](views/settings.md), [rules.md](rules.md#13-nome-macos-official-routing-truth) | [spec/architecture.md](../spec/architecture.md) | `common/.../views/usersettings/networkAndServers/NetworkAndServers.kt`, `ProtocolServersView.kt`, `AdvancedNetworkSettings.kt`, `OperatorView.kt`; Android device-connectivity provenance: [NetworkObserver.kt](../common/src/androidMain/kotlin/chat/simplex/common/helpers/NetworkObserver.kt#L16-L87) | `Chat.hs`/`Operators/Presets.hs` (Nome defaults), `Store/Profiles.hs` (bounded upgrade cleanup and conditions boundary), `Terminal.hs` (Nome CLI defaults) |
...
| PC27 | Remote Desktop | [README.md](README.md) (Desktop Features), [views/settings.md](views/settings.md), [views/nome-android.md](views/nome-android.md) | [spec/architecture.md](../spec/architecture.md), [spec/client/navigation.md](../spec/client/navigation.md), [spec/client/nome-android-ui.md](../spec/client/nome-android-ui.md) | `common/.../views/remote/ConnectDesktopView.kt`, `ConnectMobileView.kt`; Android frame test `android/.../nome/settings/NomeRemoteDesktopComposeTest.kt` | `Remote.hs`, `Remote/Types.hs` |
...
| PC32 | Nome Android UI | [views/nome-android.md](views/nome-android.md) | [spec/client/nome-android-ui.md](../spec/client/nome-android-ui.md) | **Frozen foundation, P01–P10, P13, and Milestones 1–2; Milestone 3 non-producer matrix green and local checkpoint input under final reconciliation:** Android Nome Home exposes official loaded-chat search and the existing New Chat hub. The one-time Android locale policy now freezes pre-initialization evidence and defaults only a jointly proven clean install through the official `appLanguage` owner; real clean-install, explicit-English restart/update, authentic follow-system upgrade, and unsupported-value boundaries pass. P11/P12 preserve official invitation/parser/legacy-plan owners. P14/P15 preserve official request/address owners. P16 preserves invited-group/join/delete. P17/P18 preserve loaded-chat/item/composer/actions. P19 preserves the real contact security code and verification lifecycle. P20 preserves relay selection, public-group creation, link progression, and confirmed deletion. P21 projects only real public-channel message content into the accepted Android post-card presentation while retaining role-owned composer behavior and fixed non-E2EE disclosure. P22 preserves official identities/actions/preferences and typed destructive lifecycle. The reachable private-group creation/admin and channel owner/admin P1 families are ready. P11/P12/P14/P15/P17/P18/P19/P20/P21-owner/P22/P23/P24 and all 14 P1 families are locally ready; P16's private production state is functionally ready and structurally calibrated, while its public-reference visual state is `NOT REACHABLE LOCALLY`. P11 has a real bearer-redacted API 35 READY production/baseline comparison after its QR geometry was corrected to the page baseline, and P14 has a real pending-request API 35 production/baseline comparison after its official `Direct + contactRequestId` shape was recognized. Real image-file transfer, connected audio-call lifecycle, fixed synthetic voice/video peer receipt plus production playback, controlled public-channel owner create/link/populate/open/delete/absence, and controlled official remote pair/verify/switch/stop/delete pass. Two-client public-channel Observer membership/post receipt remains explicitly not verified and is carried as the declared external validation gap, not as success. `FIRST_USE` remains onboarding-owned and `FILTERED_NO_RESULT` remains P09-owned. | N/A — official v6.5.6 Haskell/native core remains unchanged |
...
| `android/src/main/java/chat/simplex/app/MainActivity.kt` | Main Activity, ordered cold/warm notification/deep-link/share dispatch, lifecycle |
...
| `common/src/androidMain/kotlin/chat/simplex/common/ui/nome/` | Nome Android semantic tokens, theme, components, and accessibility primitives |
| `android/src/main/java/chat/simplex/app/nome/NomeProductionShell.kt` | Thin production window host; shared root retains navigation, auth, calls, overlays, intents, and back behavior |
| `common/src/androidMain/kotlin/chat/simplex/common/ui/nome/home/` | Android-only P07/P08 renderer and independent content/connectivity/core truth adapter |
| `common/src/androidMain/kotlin/chat/simplex/common/ui/nome/connection/` | Android-only P13 renderer and single-submit presentation reducer |
| `common/src/androidMain/kotlin/chat/simplex/common/views/newchat/PlatformConnectionPreview.android.kt` | Android actual that presents P13 in the existing fullscreen modal owner |
| `android/src/debug/java/chat/simplex/app/nome/` | Debug-only bilingual/light-dark fixtures, Preview, and screenshot harness |
| `android/src/{test,androidTest}/java/chat/simplex/app/nome/` | Nome foundation and home truth-table, Compose semantics, packaging, and native screenshot tests |
...
| `common/src/desktopMain/kotlin/chat/simplex/common/views/newchat/PlatformConnectionPreview.desktop.kt` | Declines Nome P13 so non-Android behavior keeps the legacy connection alert |
