...
| PC32 | Nome Android UI | [views/nome-android.md](views/nome-android.md) | [spec/client/nome-android-ui.md](../spec/client/nome-android-ui.md) | **Frozen foundation, P07/P08, P13, and Milestone 1 P01–P06; active Milestone 2 P09/P10:** Android Nome Home now exposes official loaded-chat name search and the existing New Chat action hub with unchanged Desktop fallbacks. `FIRST_USE` remains onboarding-owned; `FILTERED_NO_RESULT` is reachable only from P09's real query producer. P11–P12 and P14–P24 remain pending. | N/A — official v6.5.6 Haskell/native core remains unchanged |
