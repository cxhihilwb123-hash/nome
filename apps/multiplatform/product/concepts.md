...
| PC32 | Nome Android UI | [views/nome-android.md](views/nome-android.md) | [spec/client/nome-android-ui.md](../spec/client/nome-android-ui.md) | **Verified foundation and Batch 2 home plus authorized Batch 3 P13 source:** foundation tokens/theme/components/accessibility; Activity-owned shell; shared home seam with unchanged Desktop fallback; Android P07/P08 renderer; and the P13 `ACTION_VIEW`-only connection-preview seam, Android route/reducer/resources, typed non-logging delegates, debug host, and tests under `.../nome/connection/`. `FIRST_USE` and `FILTERED_NO_RESULT` remain unchanged; P09–P12 and P14–P24 remain deferred. | N/A — official v6.5.6 Haskell/native core remains unchanged |
