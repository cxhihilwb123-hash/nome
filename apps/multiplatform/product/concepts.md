...
| PC32 | Nome Android UI | [views/nome-android.md](views/nome-android.md) | [spec/client/nome-android-ui.md](../spec/client/nome-android-ui.md) | **Frozen foundation, P01–P10, P13, and Milestones 1–2; Milestone 3 non-producer matrix green and local checkpoint input under final reconciliation:** Android Nome Home exposes official loaded-chat search and the existing New Chat hub. The one-time Android locale policy now freezes pre-initialization evidence and defaults only a jointly proven clean install through the official `appLanguage` owner; real clean-install, explicit-English restart/update, authentic follow-system upgrade, and unsupported-value boundaries pass. P11/P12 preserve official invitation/parser/legacy-plan owners. P14/P15 preserve official request/address owners. P16 preserves invited-group/join/delete. P17/P18 preserve loaded-chat/item/composer/actions. P19 preserves the real contact security code and verification lifecycle. P20 preserves relay selection, public-group creation, link progression, and confirmed deletion. P21 derives public disclosure/observer chrome only from real channel/member facts. P22 preserves official identities/actions/preferences and typed destructive lifecycle. The reachable private-group creation/admin P1 family is ready; shared channel-admin presentation is ready but remains public-channel producer-blocked. P12/P15/P17-shell/P18/P19/P22/P23/P24 and the P20 setup surface are locally ready; P11 has a real persisted invitation but still needs a redacted-safe ready capture, P14/P16/P21 and P20 creation/link/delete await producer-backed primary states, while real P17 transfer/playback/connected-call outcomes remain producer-blocked. `FIRST_USE` remains onboarding-owned and `FILTERED_NO_RESULT` remains P09-owned. | N/A — official v6.5.6 Haskell/native core remains unchanged |
