...
@Composable
internal expect fun PlatformNomeWelcomePage(
  enabled: Boolean,
  onCreate: () -> Unit,
  onMigrate: () -> Unit,
...
@Composable
internal expect fun PlatformNomeCreateIdentityPage(
...
@Composable
internal expect fun PlatformNomeNetworkPage(
...
@Composable
internal expect fun PlatformNomeCommitmentPage(
