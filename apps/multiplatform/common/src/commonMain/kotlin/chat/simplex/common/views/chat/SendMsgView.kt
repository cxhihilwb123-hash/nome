...
fun SendMsgView(
  ...
  val composerModifier = if (appPlatform.isAndroid) {
    Modifier
      .padding(padding)
      .heightIn(min = 48.dp)
  ...
  Box(composerModifier) {
    ...
    Box(Modifier.align(Alignment.BottomEnd).padding(bottom = if (appPlatform.isAndroid) 6.dp else 5.sp.toDp() * fontSizeSqrtMultiplier)) {
