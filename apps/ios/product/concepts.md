...
| 32 | Nome Product Experience | [views/nome-experience.md](views/nome-experience.md) | [spec/client/nome-brand-overlay.md](../spec/client/nome-brand-overlay.md) | `Shared/SimpleXApp.swift`, `Shared/ContentView.swift`, `Shared/Views/Onboarding/`, `Shared/Views/ChatList/ChatListView.swift`, `Shared/Views/NewChat/`, `Shared/Views/Chat/ChatView.swift`, `Shared/Views/UserSettings/`, `Shared/Assets.xcassets/`, `../../scripts/ios/capture-nome-accessibility-previews.sh` | N/A (presentation-only overlay) |
