...
struct UserPicker: View {
    ...
    var body: some View {
        ...
        VStack(spacing: sectionSpacing) {
            ...
            VStack(spacing: 0) {
                openSheetOnTap("qrcode", title: m.userAddress == nil ? "Create public contact address" : "Your public contact address", sheet: .address, disabled: stopped)
                openSheetOnTap("switch.2", title: "Chat preferences", sheet: .chatPreferences, disabled: stopped)
                openSheetOnTap("person.crop.rectangle.stack", title: "Identity center", sheet: .chatProfiles, disabled: stopped)
