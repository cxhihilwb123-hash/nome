...
- Latest directly installed Android artifact: [`builds/20260730_nome_android_6.5.6_code371_channel_relay_e2e.md`](./builds/20260730_nome_android_6.5.6_code371_channel_relay_e2e.md), internal Debug arm64 APK with the default Nome channel relay and Nome invitation-link routing; unit/build gates, preserved-data upgrades, live relay tests, and real two-device create/join/broadcast delivery PASS. The formal clean-source gate remains blocked by preserved unrelated iOS dirty paths, so this is not a public-release claim.
