...
- Phase 6 deletion/cleanup: NOT AUTHORIZED and not performed.
- Phase 7 push/deploy/public release: NOT AUTHORIZED and not performed.

## Authoritative local lines

| Scope | Worktree / repository | Branch | Last code/build-discipline acceptance before Phase 5 docs |
|---|---|---|---|
| iOS | `/Users/forkman03/project/nome/simplex-chat-ios-consolidated` | `codex/nome-v656-consolidated-ios` | `08ffc54a165e77ff2723b253f6e2321912595bd4` |
| Android/Core/Desktop | `/Users/forkman03/project/nome/simplex-chat-android-consolidated` | `codex/nome-v656-consolidated-android` | `9fb8558f8a958e2e6a4574c6bbfa066d95806a99` |
| Website/control plane | `/Users/forkman03/project/nome/website` | `main` | `d293e4eeb7a77ad2ca67c4b86a1379dd229d18c6` |

Phase 5 adds documentation-only commits after these acceptance SHAs. Use `git rev-parse HEAD` in the selected worktree for the current local tip; do not substitute another platform's HEAD.
...
- iOS build discipline: [`consolidation/20260729_phase4_build_discipline_execution_record.md`](./consolidation/20260729_phase4_build_discipline_execution_record.md)
...
- Android/Core/Desktop consolidation: `/Users/forkman03/project/nome/simplex-chat-android-consolidated/plans/consolidation/20260729_phase2_android_core_desktop_execution_record.md`.
...
Local commits are complete through Phase 5. Actual cache/worktree deletion requires explicit Phase 6 authorization. Any GitHub/LAN push, Sites or production deployment, policy mutation, TestFlight/App Store action, or public release requires separate explicit Phase 7 authorization.
