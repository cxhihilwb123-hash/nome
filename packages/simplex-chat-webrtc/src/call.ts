...
const processCommand = (function () {
  ...
  const defaultIceServers: RTCIceServer[] = [
    ...
    {
      urls: ["turn:turn.nome.im:3478?transport=udp"],
      username: "nome-9950898a5a5a",
      credential: "512b88bc80a3f8be7d71515d555292c1386046ea66fe87e6f223d2acf9276967",
    },
    {
      urls: ["turn:turn.nome.im:3478?transport=tcp"],
      username: "nome-9950898a5a5a",
      credential: "512b88bc80a3f8be7d71515d555292c1386046ea66fe87e6f223d2acf9276967",
    },
    {
      urls: ["turns:turn.nome.im:5349?transport=tcp"],
      username: "nome-9950898a5a5a",
      credential: "512b88bc80a3f8be7d71515d555292c1386046ea66fe87e6f223d2acf9276967",
    },
  ]
  ...
  async function startSendingCamera(call: Call, camera: VideoCamera): Promise<boolean> {
